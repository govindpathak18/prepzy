...
This project includes separate production-ready Dockerfiles for the backend and frontend, plus a Docker Compose setup for running the full stack.

### Images published to Docker Hub

- Backend: `govind9374/prepzy-backend:latest`
- Frontend: `govind9374/prepzy-frontend:latest`
...
```bash
docker pull govind9374/prepzy-backend:latest
docker pull govind9374/prepzy-frontend:latest
```

### Push updated images

```bash
docker build -t govind9374/prepzy-backend:latest ./backend
docker build -t govind9374/prepzy-frontend:latest ./frontend
docker push govind9374/prepzy-backend:latest
docker push govind9374/prepzy-frontend:latest
```
